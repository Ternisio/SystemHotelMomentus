...
public abstract class MaskFieldUtil {
     ...
     *                 value = value.replaceFirst("\\.(\\d{3})(\\d)", ".$1-$2");
     *                 value = value.replaceFirst("(\\d{14})", "$1");
     *                 textField.setText(value);
     *                 positionCaret(textField);
     *                 });
     *
     * @param textField TextField
     */
    private static final String DATE_TIME_PATTERN = "\\d{0,2}/\\d{0,2}/\\d{0,4} \\d{0,2}:\\d{0,2}";
     ...
     * @param textField TextField
     */
    public static void hora(final TextField textField) {
    ...
    public static void Data_e_hora(TextField textField) {
        ...
        textField.setOnKeyTyped((KeyEvent event) -> {
            ...
            if(event.getCharacter().trim().length()==0){ // apagando
                ...
                String oldvalue = textField.getText().substring(0,textField.getText().length() - 1);
            ...
            try{
                       if (!textField.getText().equals("") ) parseInt(str);
                        if(textField.getText().length()==16) event.consume();
                    ...
                    textField.setText(oldvalue+":"+str);
                    textField.positionCaret(textField.getText().length());
                }
